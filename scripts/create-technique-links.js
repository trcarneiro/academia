...
async function main() {
  ...
  // 1. Buscar todas as atividades que criamos
  ...
  for (const activity of activities) {
    ...
    // Verificar se Technique já existe
    ...
    if (!technique) {
      ...
      technique = await prisma.technique.create({
        data: {
          ...
          difficulty: activity.difficulty === 'Iniciante' ? 1 : activity.difficulty === 'Intermediário' ? 2 : 3,
  ...
  // 3. Criar vínculos LessonPlanTechniques
