...
app.get("/api/activities", (req, res) => {
    res.json({
        ...
        data: [
            {
                id: "1",
                name: "Treino de Técnicas Básicas",
                type: "TRAINING",
                date: "2025-08-17",
...
// Financial endpoints
app.get("/api/financial/subscriptions", (req, res) => {
    res.json({
        success: true,
        data: [
            {
        ...
        data: [
            {
                ...
                category: "KICKS",
                level: "BASIC",
                description: "Técnica básica de chute frontal"
            }
        ]
    });
});
...
app.get("/api/rag", (req, res) => {
    res.json({
        ...
        data: [
            {
                id: "1",
                question: "Como executar um chute frontal?",
                answer: "O chute frontal é executado elevando o joelho...",
                confidence: 0.95
            }
        ]
    });
