...
class CheckinController {
    ...
    async init() {
        try {
            ...
            // 🛡️ BROWSER CACHE DEFENSE: Polyfill showMatch if missing
            // This handles cases where spa-router/Controller are new but CameraView is cached old version
            if (this.cameraView && typeof this.cameraView.showMatch !== 'function') {
                console.warn('⚠️ CameraView.showMatch missing (cached version?), patching dynamically...');
