/**
 * Lesson Plans List Controller - Guidelines.MD Compliant
 * 
 * Manages the lesson plans list with search, filtering, pagination,
 * and CRUD operations following the Students module pattern.
 */

export class LessonPlansListController {
    constructor(api) {
        this.api = api;
        this.currentPage = 1;
        this.pageSize = 20;
