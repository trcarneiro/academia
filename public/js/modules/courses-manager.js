...
(function(window) {
    ...
    function renderCoursesTable(courses) {
        ...
        tableBody.innerHTML = courses.map(course => `
            <tr ondblclick="window.location.href='/views/course-editor.html?id=${course.id}'">
                <td>${course.name || '-'}</td>
                <td>${course.level || '-'}</td>
                ...
                <td>
                    <button class="btn btn-secondary" onclick="window.location.href='/views/course-editor.html?id=${course.id}'">Editar</button>
                </td>
            </tr>
        `).join('');
    }
