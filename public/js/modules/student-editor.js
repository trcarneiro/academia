(function() {
    ...
    console.log('✅ initializeStudentEditor exported to window object');
    
    // Module initialization
    async function initializeStudentEditor() {
        if (isInitialized) {
            console.log('ℹ️ Student editor already initialized, skipping...');
            return;
        }
        ...
        try {
            // Check if we're on the student editor page
            if (!document.querySelector('.students-isolated')) {
                console.log('ℹ️ Not on student editor page, skipping initialization');
                return;
            }
            ...
            // If no ID in URL, check localStorage for navigation intent
            if (!studentId) {
                console.log('🔍 No ID in URL, checking localStorage...');
                const editorMode = localStorage.getItem('studentEditorMode');
                console.log('📱 localStorage studentEditorMode:', editorMode);
